...
Channel1 as Channel,
CASE
  WHEN Channel1 = 'tripadvisor' THEN sum(commission)-sum(ta_cost*(TIME_DIFF(CURRENT_TIME,TIME "00:00:00",HOUR)
/
24))-sum(gbv*0.03)
  WHEN Channel1 = 'trivago' THEN sum(commission)-sum(trivago_cost*(TIME_DIFF(CURRENT_TIME,TIME "00:00:00",HOUR)
/
24))-sum(gbv*0.03)
  WHEN Channel1 = 'hotelscombined' THEN sum(commission)-sum(hotelscombined_cost *(TIME_DIFF(CURRENT_TIME,TIME "00:00:00",HOUR)
/
24))-sum(gbv*0.03)
