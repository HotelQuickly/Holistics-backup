...
select
lose_impr/ impr as lose_percent
from
(
with tv as
(
select
date,
SUM(lose*hotel_impr) as tv_lose_impr,
...
select
date,
sum(total_available - total_meets - total_beats) as ta_lose_impr,
...
select
tv.date as dt,
(tv_lose_impr + ta_lose_impr) as lose_impr,
