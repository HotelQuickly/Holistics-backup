...
where 1=1
and date(m01_order_datetime_gmt0) = date_sub(current_date(), interval 1 DAY)
group by 1,2,3,4,5
order by 6 desc
),
ytd1 as
...
from `analyst.all_orders`
where 1=1
and date(m01_order_datetime_gmt0) = date_sub(current_date(), interval 2 DAY)
group by 1,2,3,4,5
order by 6 desc
),
ytd2 as
...
from `analyst.all_orders`
where 1=1
and date(m01_order_datetime_gmt0) = date_sub(current_date(), interval 3 DAY)
group by 1,2,3,4,5
order by 6 desc
),
ytd3 as
...
from `analyst.all_orders`
where 1=1
and date(m01_order_datetime_gmt0) = date_sub(current_date(), interval 4 DAY)
group by 1,2,3,4,5
order by 6 desc
),
ytd4 as
...
from `analyst.all_orders`
where 1=1
and date(m01_order_datetime_gmt0) = date_sub(current_date(), interval 5 DAY)
group by 1,2,3,4,5
order by 6 desc
),
ytd5 as
...
from `analyst.all_orders`
where 1=1
and date(m01_order_datetime_gmt0) = date_sub(current_date(), interval 6 DAY)
group by 1,2,3,4,5
order by 6 desc
),
ytd6 as
...
from `analyst.all_orders`
where 1=1
and date(m01_order_datetime_gmt0) = date_sub(current_date(), interval 7 DAY)
group by 1,2,3,4,5
order by 6 desc
),
ytd15 as
...
select
  *,
  rank() over(order by gbv desc) rank
from ytd
order by gbv desc
),
ytd1rank as
