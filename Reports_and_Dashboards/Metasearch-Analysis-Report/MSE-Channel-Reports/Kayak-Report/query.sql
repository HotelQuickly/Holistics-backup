...
WHERE 1=1
AND lower(d180_order_referral_source_code) = 'kayak'
...
Markup_Amount,
Markup_Percent,
ROUND(kayak_cost.cost,0) as Cost,
ROUND((Commission-GBV*0.03),0) as Margin,
ROUND((Commission-kayak_cost.Cost-GBV*0.03),0) as PC3
FROM kayak_data
LEFT JOIN kayak_clicks ON 1=1
AND kayak_data.Date1 = kayak_clicks.Date2
LEFT JOIN kayak_cost ON 1=1
AND kayak_data.Date1 = kayak_cost.Date3
ORDER BY 1 DESC
