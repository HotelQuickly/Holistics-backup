...
sum(case when d22_inventory_source_code = 'gta02' then m07_selling_price_total_usd end) as gta02,
sum(case when d22_inventory_source_code = 'gta03' then m07_selling_price_total_usd end) as gta03,
...
sum(case when d22_inventory_source_code NOT IN ('zumata','siteminder','hq','hotelbeds','gta','gta02','gta03','expedia','dotw','agodaparser') then m07_selling_price_total_usd end) as others
from
analyst.all_orders
where
